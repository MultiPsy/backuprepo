...
int CI::CheckInputs ()
{
  //printf("<FMC_CI4.cpp> CheckInputs()---------------------------------------------\n");
int i;//,j,n;
...
/* If there is no weather stream data than we need weather & wind data */
 ...
 if ( i < 0 )
  ...
  //printf("<FMC_CI4.cpp> end of CheckInputs()---------------------------------------------\n");
  return 1;
}
...
{
  //printf("<FMC_CI4.cpp> CheckWeatherStream()---------------------------------------------\n");
int i;
d_RAWS *a,*b;
  ...
  //printf("<FMC_CI4.cpp> end of CheckWeatherStream()---------------------------------------------\n");
  return 1;
}
...
{
  //printf("<FMC_CI4.cpp> CheckWeatherWind()---------------------------------------------\n");
int i,j,k, n;
...
/* basic error check, only do for station 0, setup to only report the  */
  ...
  //printf("<FMC_CI4.cpp> end of for loop CheckWeatherWind()\n");
/*......................................................................*/
...
{
  //printf("<FMC_CI4.cpp> RAWS_SetMinuteDate()---------------------------------------------\n");
int i_StrYr, iX;
d_RAWS *a;
...
/* Start Simulation Time, expressed as a Minute Date, see declaration notes */
 ...
 //printf("<FMC_CI4.cpp> end of RAWS_SetMinuteDate()---------------------------------------------\n");
