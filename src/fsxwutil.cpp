...
void CompareRect::InitRect(long NumFire)
{
	...
	//printf("\n\n\nNumFire = %ld\nCurrentFire Xhi = %lf, CurrentFire Xlo = %lf\n", NumFire, Xhi, Xlo);
	//printf("CurrentFire Yhi = %lf CurrentFire Ylo = %lf\n\n\n", Yhi, Ylo);
}
...
{
	//printf("<fsxwutil.cpp> BoundingBox()---------------------------------------------\n");
	...
	pFarsite->SetPerimeter1(NumFire, NumPoint, Xlo, Xhi);	// polygon 도형 좌표 설정
	pFarsite->SetFireChx(NumFire, NumPoint, Ylo, Yhi);
	//printf("<fsxwutil.cpp> Xlo = %lf, Ylo = %lf, Xhi = %lf, Yhi = %lf\n", Xlo, Ylo, Xhi, Yhi);
}
