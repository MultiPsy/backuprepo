...
int CFMC::Run ()
{
   //printf("<FMC_CFMC.cpp> Run()---------------------------------------------\n");
int i;
   i = this->a_FE2->CondMngr();
   //printf("<FMC_CFMC.cpp> end of Run()---------------------------------------------\n");
   return i;
}
...
{
  //printf("<FMC_CFMC.cpp> CheckInputs()---------------------------------------------\n");
int i;
  i = a_FE2->a_CI->CheckInputs();
  //printf("<FMC_CFMC.cpp> end of CheckInputs()---------------------------------------------\n");
  return i;
}
...
{
   //printf("<FMC_CFMC.cpp> Set_FarsiteDef()---------------------------------------------\n");
int i;
